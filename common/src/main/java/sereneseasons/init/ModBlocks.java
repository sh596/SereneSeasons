...
import sereneseasons.block.DumbCropBlock;
...
public class ModBlocks
{
    public static void registerBlocks(BiConsumer<ResourceLocation, Block> func)
    {
        ...
        SSBlocks.DUMB_CROP = register(func, new DumbCropBlock(Block.Properties.of().noCollission().noOcclusion().randomTicks().sound(SoundType.CROP)), "dumb_crop");
    }
